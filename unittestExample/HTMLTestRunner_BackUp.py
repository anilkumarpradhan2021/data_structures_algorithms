...
class _TestResult(TestResult):
    ...
    # It lacks the output and reporting ability compares to unittestExample._TextTestResult.
    ...
    def stopTest(self, test):
        ...
        # But there are some path in unittestExample that would bypass this.
...
class HTMLTestRunner(Template_mixin):
    ...
    def sortResult(self, result_list):
        # unittestExample does not seems to run in any particular order.
...
# Note: Reuse unittestExample.TestProgram to launch test. In the future we may
# build our own launcher to support more specific command line
# parameters like test title, CSS, etc.
class _TestProgram(TestProgram):
    """
    A variation of the unittestExample.TestProgram. Please refer to the base
