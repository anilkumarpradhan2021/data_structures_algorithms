...
def largestSubStringUsingDP(string1, string2):
    ...
    print(string2[(maximum_sub_string_i - maximum_sub_string_length) :maximum_sub_string_i])
...
if __name__ == '__main__':
    ...
    largestSubStringUsingDP(string1, string2)
    print()
